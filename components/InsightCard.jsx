...
>
  <img
    src={imgUrl}
    alt="planet-01"
    className="md:w-[270px] w-full h-[280px] rounded-[30px] object-cover"
  />
  ...
  <div className="w-full flex justify-between items-center">
    ...
    <div className="lg:flex hidden items-center justify-center w-[100px] h-[100px] rounded-full bg-transparemt border-[1px] border-white">
      <img
        src="arrow.svg"
        alt="arrow"
